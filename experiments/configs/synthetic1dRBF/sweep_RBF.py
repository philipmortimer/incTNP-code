...
CONFIGS = {
    ...
    "batched": "gp_batched_causal_tnp_rbf_rangesame.yaml",
    "batched_lr_sched": "gp_batched_causal_tnp_lr_scheduler_rbf_rangesame.yaml",
}
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=float,
        default=[1e-4, 3e-4, 5e-4, 1e-3, 2e-3, 5e-3],
        help="Learning rates to sweep (default: 1e-4 3e-4 5e-4 1e-3 2e-3 5e-3)",
    )
    parser.add_argument(
        "--max_ncs",
        nargs="+",
    ...
    config_path = f"experiments/configs/synthetic1dRBF/{config_filename}"
