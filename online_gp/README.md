(NOTE FROM incTNP paper. This repo here is online_gp taken from https://github.com/wjmaddox/online_gp . None of this code is ours, we include it here to make installing WISKI easier.)
